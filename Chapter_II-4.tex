...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{Chapter_II-4_String-Memory}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{Chapter_II-4_String-Memory2}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Chapter_II-4_String-Copy}
\end{figure}
كلّ محرف من
\InlineCode{string}
يتمّ وضعه في
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Chapter_II-4_String-Concatenation}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{Chapter_II-4_String-Search}
\end{figure}
