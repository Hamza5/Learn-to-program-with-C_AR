...
\Picture{Chapter_II-4_String-Concatenation}
الجدول
\InlineCode{string2}
...
\Picture{Chapter_II-4_String-Search}
...
\InlineCode{printf}
تكتب في... سلسلة محرفيّة ! و من هذا اسمها الذي يبدأ بـ"\textenglish{s}" من "\textenglish{string}" (سلسلة محرفيّة بالإنجليزيّة).
