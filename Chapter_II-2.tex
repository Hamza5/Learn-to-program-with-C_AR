...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{Chapter_II-2_RAM-Schema}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Chapter_II-2_RAM-Schema-Pointer}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{Chapter_II-2_RAM-Schema-Pointer2}
\end{figure}
