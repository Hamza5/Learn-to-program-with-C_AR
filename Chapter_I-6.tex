...
لكي نجرّب الشفرات السابقة و نفهم كيف يعمل \InlineCode{if}، يجب أن نضعه داخل الدالة
\InlineCode{main}
...
بعض المبتدئين يقومون بإضافة فاصلة منقوطة في نهاية سطر \InlineCode{if}، و لكن \InlineCode{if} هو شرط و لا نضع فاصلة منقوطة إلّا في نهاية تعليمة. الشفرة التالية لن تعمل كما هو متوقّع لأنّه يوجد
\InlineCode{;}
في نهاية الشرط.
...
أيضًا أو 
\InlineCode{else}
في الشروط التي تنشئها ب\InlineCode{if}.
