...
\usepackage[breaklinks,
            ...
            pdfpagelayout=TwoPageRight]{hyperref} % For hyperlinks and PDF metadata
\usepackage{float}
...
% Boxes definitions
\tcbset{arc=2pt, enhanced, attach boxed title to top right={yshift=-\tcboxedtitleheight/2, xshift=\tcboxedtitlewidth/2},
...
\newtcolorbox{warning}{colback=warningback, colframe=warningframe, title=!, coltitle=warningtitle,
