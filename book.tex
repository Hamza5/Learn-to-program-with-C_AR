...
\lstdefinestyle{C}{language=C, showstringspaces=false, numbers=left,
    	...
    	morekeywords={SDL_Surface,Uint32,SDL_Rect,SDL_Event,SDL_TimerID,SDL_NewTimerCallback},
        ...
        time,SDL_Delay,SDL_GetTicks,SDL_AddTimer,SDL_RemoveTimer,
        malloc,free,SDL_CreateRGBSurface,SDL_FreeSurface,SDL_BlitSurface,SDL_LoadBMP,SDL_WM_SetIcon,IMG_Load,
        SDL_Init,SDL_Quit,SDL_SetVideoMode,SDL_WM_SetCaption,SDL_FillRect,SDL_Flip,SDL_MapRGB,SDL_SetAlpha,SDL_SetColorKey,
    	SDL_PollEvent,SDL_WaitEvent,SDL_EnableKeyRepeat,SDL_ShowCursor,SDL_WarpMouse},
