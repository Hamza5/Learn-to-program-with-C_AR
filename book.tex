...
\lstset{language=C, showstringspaces=false, frame=single, numbers=left,
        ...
        morecomment=[l][\color{DarkOrange}]{\#}, showlines,
        deletekeywords={return,if,else,switch,for,while,do,const},
        morekeywords=[2]{return,if,else,switch,for,while,do,const}, keywordstyle=[2]\bfseries\color{Magenta},
