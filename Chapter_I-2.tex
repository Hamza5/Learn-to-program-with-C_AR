...
كل واحدة من هذه البيئات تمكنك من البرمجة ومتابعة بقيّة الكتاب من دون أيّة مشاكل. بعضها كامل أكثر من ناحية المميزات، وأخرى سهلة الإستخدام أكثر، ولكن في كلّ الأحوال البرامج الّتي تنشؤها تكون ذاتها أيّا كانت البيئة التي اِخْتَرْتها. فهذا الخيار ليس بالأهمّية الّتي تعتقدها.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Chapter_I-2_CodeBlocks}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Chapter_I-2_CodeBlocks-New-project}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Chapter_I-2_CodeBlocks-C}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Chapter_I-2_CodeBlocks_project-path}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Chapter_I-2_CodeBlocks_Compiler}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Chapter_I-2_Visual-Cpp}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Chapter_I-2_Visual-Cpp-New-project}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Chapter_I-2_Visual-Cpp-Welcome}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Chapter_I-2_Visual-Cpp-Parameters}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\textwidth]{Chapter_I-2_Visual-Cpp-New-source}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Chapter_I-2_Visual-Cpp-New-file}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Chapter_I-2_Visual-Cpp-main}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Chapter_I-2_Xcode-New-project}
\end{figure}
...
بمجرّد إنشائه، سيتّم عرض مشروعك على شكل مجلّد يحتوي على العديد من الملفّات في \InlineCode{Finder}.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Chapter_I-2_Xcode-main}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{Chapter_I-2_Xcode-C}
\end{figure}
