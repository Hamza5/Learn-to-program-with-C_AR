...
<div dir='rtl'>
ترجمة الدرس و مراجعته تمّت بشكل متقطع على مدى السنوات الأربع الأخيرة و الآن يتم تحضيرها على شكل كتاب رقمي.
</div>
...
- [x] <span dir='rtl'>هياكل البيانات</span>
    - [x] <span dir='rtl'>القوائم المتسلسلة</span>
    - [x] <span dir='rtl'>المكدّسات و الطوابير</span>
    - [x] <span dir='rtl'>جداول التجزئة</span>
- [x] <span dir='rtl'>الخاتمة</span>

<div dir='rtl'>
**تمّت كتابة كلّ الفصول و لم يتبقّ سوى تصميم الغلاف و المراجعة العامة الأخيرة. سيصدر الكتاب قريبا !**
</div>
